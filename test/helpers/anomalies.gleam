...
import core/models/planetary_system.{AsteroidField, GravityRift, Nebula, Supernova}
...
pub fn nebula_at(h: Hex) -> MovementContext {
  MovementContext(enemy_fleets: [], anomalies: [#(h, Nebula)], player_technologies: [])
}

pub fn supernova_at(h: Hex) -> MovementContext {
  MovementContext(enemy_fleets: [], anomalies: [#(h, Supernova)], player_technologies: [])
}

pub fn gravity_rift_at(h: Hex) -> MovementContext {
  MovementContext(enemy_fleets: [], anomalies: [#(h, GravityRift)], player_technologies: [])
}
...
pub fn asteroid_field_at(h: Hex) -> MovementContext {
  MovementContext(enemy_fleets: [], anomalies: [#(h, AsteroidField)], player_technologies: [])
}
